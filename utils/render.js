if (!nabu) { var nabu = {}; }
if (!nabu.utils) { var nabu.utils = {}; }
if (!nabu.utils.vue) { var nabu.utils.vue = {}; }

// Parameters are:
// - target: a element, a vue component or the id of an element (required)
// - component: the component to add, this can be string (set as innerhtml), a vue component that is mounted or a simple element
// - elementHandler: a handler that receives the element where the content will be added
